...
<body style="background-image:url('<?= base_url('assets/img/griyahusada.jpeg') ?>') ;  background-repeat: no-repeat;  background-size: cover;">
                                ...
                                <div class="col-12">
                                    <div class="row justif-content-center">
                                        ...
                                        <div class="col-11 text-center">
                                            <h3 class="ml-auto mr-auto">Sistem Informasi Sistem Rekam Medis Rumah Sakit griya Husada madiun</h3>
                                        </div>
                                    </div>
                                </div>
